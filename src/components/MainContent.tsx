...
export function MainContent({ readings, onWater, badges, activeSection }: MainContentProps) {
    ...
    <motion.div className="bg-gradient-to-br from-kid-blue-100 to-kid-blue-200 rounded-3xl shadow-xl p-6 border-4 border-kid-blue-300">
      ...
      <div className="relative h-28 bg-white/70 rounded-2xl overflow-hidden border-2 border-kid-blue-300">
        ...
        <motion.div
          animate={{ y: [0, 5, 0] }}
          transition={{ repeat: Infinity, duration: 2 }}
          className="absolute bottom-0 w-full h-2 bg-white/30"
        />
      </div>
      <p className="text-kid-blue-800 mt-3 text-center font-fredoka font-semibold text-lg">{((readings.water / 4095) * 100).toFixed(0)}% Full</p>
    </motion.div>
  ...
  const renderLight = () => (
    <div className="space-y-6">
      ...
      <div className="bg-white/60 rounded-2xl p-6 border-2 border-kid-yellow-200">
        <h3 className="text-xl font-fredoka font-bold text-kid-yellow-700 mb-3 flex items-center gap-2">
          <motion.div
            animate={{ scale: [1, 1.1, 1] }}
            transition={{ repeat: Infinity, duration: 2 }}
          >
        ...
        <p className="text-kid-yellow-800 font-fredoka text-lg">
  ...
  const renderMotion = () => {
    const motionLogs = [
      { icon: "🐔", text: "Chicken detected!", time: "9:15 AM" },
      { icon: "🦋", text: "Butterfly fluttered by!", time: "9:12 AM" },
      { icon: "🐔", text: "Chicken detected!", time: "9:05 AM" },
    ];
    return (
      <div className="space-y-6">
        <SectionHeading title="Motion" emoji="🏃" />
  ...
  const renderTemperature = () => (
    <div className="space-y-6">
      ...
      <div className="bg-white/90 rounded-3xl shadow-xl p-6 border-4 border-kid-orange-200">
        <h3 className="font-fredoka font-bold text-kid-orange-800 text-lg mb-3">Temperature Control</h3>
        <div className="flex justify-center items-center h-24">
          <div className="relative w-full h-4 bg-gray-200 rounded-full">
            <div className="absolute top-0 left-0 h-full bg-gradient-to-r from-blue-400 via-green-400 to-red-400 rounded-full" style={{ width: '100%' }}></div>
            <div className="absolute top-1/2 -translate-y-1/2 h-6 bg-green-500 rounded-full" style={{ left: '40%', width: '30%' }}></div>
            <motion.div
              className="absolute top-1/2 -translate-y-1/2 w-8 h-8 bg-white rounded-full border-4 border-orange-500 shadow-lg"
              style={{ left: `${((readings.temp - 10) / 30) * 100}%` }}
            ></motion.div>
          </div>
        </div>
  ...
  const renderWater = () => {
    const waterLogs = [
      { icon: "💧", text: "Watered the plant", time: "9:00 AM" },
      { icon: "💧", text: "Watered the plant", time: "Yesterday" },
    ];
